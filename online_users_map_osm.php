...
function createMarker(user){
    if (user.lat != "" && user.lng != "") {
        ...
        var image = '<?php p($CFG->wwwroot);?>/blocks/online_users_map/images/';
        if (user.online == "true") {
            var icon = new OpenLayers.Icon(image + 'online_noshadow.png', size, offset);
        } else {
            var icon = new OpenLayers.Icon(image + 'offline_noshadow.png', size, offset);
        }
